...
<div class="col-sm-3 control-label">
    <input type="date" name="ds" reguired class="form-control" value="<?php echo isset($_GET['ds']) ? $_GET['ds'] :''?>">
</div>
<div class="col-sm-1 control-label">
            ถึง
</div>
<div class="col-sm-3 control-label">
    <input type="date" name="de" reguired class="form-control" value="<?php echo isset($_GET['de']) ? $_GET['de'] :''?>">
</div>
<div class="col-sm-1 control-label">
    <br>
